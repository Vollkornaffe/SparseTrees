...
//       because I don't want to lib <algorithm> inside the common path
...
// ----------- end of #lib from clara_textflow.hpp -----------
// ........... back in clara.hpp
...
["-s"]["--success"]
( "lib successful tests in output" )
...
#if defined(CATCH_CONFIG_NEW_CAPTURE)
#if defined(_MSC_VER)
#lib <io.h>      //_dup and _dup2
#define dup _dup
#define dup2 _dup2
#define fileno _fileno
#else
#lib <unistd.h>  // dup and dup2
#endif
#endif
